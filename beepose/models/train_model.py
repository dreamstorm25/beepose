...
def batchNormalize(x): return BatchNormalization()(x)
...
def apply_mask(x, mask1, mask2, num_p, stage, branch,npi=12):
...
def get_training_model_new(weight_decay,np1=38,np2=19,stages=6,keras_preprocessing=False):
    ...
    w1 = apply_mask(stage1_branch1_out, vec_weight_input, heat_weight_input, np_branch1, 1, 1, np1)
    ...
    for sn in range(2, stages + 1):
        ...
        w1 = apply_mask(stageT_branch1_out, vec_weight_input, heat_weight_input, np_branch1, sn, 1, np1)
    ...
    return model
def get_testing_model_new(np1=38,np2=19,stages=6, keras_preprocessing=False):
    stages = stages
    np_branch1 = np1
    np_branch2 = np2
